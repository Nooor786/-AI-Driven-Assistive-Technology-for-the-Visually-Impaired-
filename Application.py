...
GOOGLE_API_KEY = "AIzaSyCFQAjNs7iLHuJeTj0nplZU-2ByL6gQnc4"
...
# Function to convert text to speech (using a male voice)
def text_to_speech(text):
    tts = gTTS(text=text, lang='en', tld='co.uk', slow=False)  # Male voice with 'co.uk'
...
1.....Upload an Image
2.....Select an option:
      🖼️ Scene Description: Receive a detailed description of the image.
      📜 Text Extraction: Extract any text present in the image.
      🚧 Object & Obstacle Detection: Identify obstacles and objects.
      🛠️ Tailored Assistance: Get help customized to your specific needs.
3.....Results will be provided in an easy-to-understand format, including audio if desired.
    """)
